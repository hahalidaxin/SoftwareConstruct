 ...
 * @author hahalidaxin
 */
public class SocialNetworkNioStrategy implements SocialNetworkIoStrategy {
   ...
   * @param line  行数据
   */
  public static void writeByLine(FileChannel outCh, byte[] line) {
    try {
  ...
  public void write(SocialNetworkCircle snc, String filepath) {
    ...
    try {
      ...
      writeByLine(outCh, (snc.getCentralUserInfo() + "\n").getBytes());
