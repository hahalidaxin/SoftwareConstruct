...
// Rep Explosure ：与ConcreteCircularOrbit相同
    ...
    public TrackCircularOrbit(CentralObject co, Map<Track, List<Runner>> pm, List<Relation<CentralObject, Runner>> rel1, Map<Runner, List<Relation<Runner, Runner>>> rel2) {
