...
//    Rep Explosure：没有暴露方法
    ...
    public SocialNetworkCircularOrbit(CentralUser co, Map<Track, List<Friend>> pm, List<Relation<CentralUser, Friend>> rel1, Map<Friend, List<Relation<Friend, Friend>>> rel2) {
